...
def estimate_state(machine_state_list_belief_prability,cred_state_list_belief_prability):
    ...
    machine_state_list_estimated= [probability>0.5 for probability in machine_state_list_belief_prability]
    cred_state_list_estimated=[probability>0.5 for probability in cred_state_list_belief_prability]
